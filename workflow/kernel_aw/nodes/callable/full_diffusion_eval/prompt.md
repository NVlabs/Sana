...
has explicitly requested full target-model diffusion validation. Do not use it as an
...
- preserve the target model's official benchmark shape, prompt, seed, frame
  count, scheduler, and model profile;
