...
def default_candidate(model_id: str) -> str:
    return f"candidates/{model_id}_baseline.toml"
...
def create(args: argparse.Namespace, *, root: Path | None = None) -> dict[str, Any]:
    ...
    candidate = args.candidate or default_candidate(model_id)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    create_p.add_argument("--candidate")
