...
from diffusion.refiner.vendor.ltx_core.components.patchifiers import (
    AudioLatentShape,
    AudioPatchifier,
...
from diffusion.refiner.vendor.ltx_core.components.protocols import Patchifier
from diffusion.refiner.vendor.ltx_core.types import LatentState, SpatioTemporalScaleFactors
...
class VideoLatentTools(LatentTools):
    ...
    def create_initial_state(
        ...
        """Create an initial patchified LatentState.

        Args:
            temporal_offset: Global latent-frame offset for this window.
                E.g. if this window covers latent frames [9..19],
                pass ``temporal_offset=9`` so that RoPE positions are
                globally continuous across windows.
        """
