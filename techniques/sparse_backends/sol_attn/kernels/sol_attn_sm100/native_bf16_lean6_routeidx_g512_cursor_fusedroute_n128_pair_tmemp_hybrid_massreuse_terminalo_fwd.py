...
from experiments.sol_attn.probe_native_bf16_n256_deferred_leaf import (
...
from kernels.sol_attn_sm90._compat import layout_utils
from kernels.sol_attn_sm90.selector import (
    sol_attn_bfind_b32,
                    ...
                    for word in cutlass.range_constexpr(ROUTE_MASK_WORDS):
                        ...
                        if lane == Int32(0):
                            if cutlass.const_expr(word == 0):
                                ...
                                mask3 = bit_value
                    if lane == Int32(0):
                        exact_count = sol_attn_count_exact_bits_popc(
...
class SolAttentionSm100Lean6RouteidxG512CursorFusedrouteN128PairTmempBf16Forward:
...
def build_sol_attn_sm100_lean6_routeidx_g512_cursor_fusedroute_n128_pair_tmemp_bf16_fwd(
    T: int,
    *,
    is_causal: bool = False,
) -> SolAttentionSm100Lean6RouteidxG512CursorFusedrouteN128PairTmempBf16Forward:
    """Build the ordinary no-trace full-grid sibling."""

    return SolAttentionSm100Lean6RouteidxG512CursorFusedrouteN128PairTmempBf16Forward(
        T, is_causal=is_causal
    )


def build_sol_attn_sm100_lean6_routeidx_g512_cursor_fusedroute_n128_pair_tmemp_bf16_trace_fwd(
    T: int,
    *,
    is_causal: bool = False,
) -> SolAttentionSm100Lean6RouteidxG512CursorFusedrouteN128PairTmempBf16Forward:
