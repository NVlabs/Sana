...
by [`a100_fullopt.toml`](../../../config/minimax_h3/a100_fullopt.toml).
...
```bash
python3 scripts/run.py config/minimax_h3/a100_fullopt.toml                 # the optimized arm
...
```bash
python3 scripts/run.py config/minimax_h3/a100_fullopt.toml \
...
```bash
python3 scripts/launch_config.py config/minimax_h3/a100_fullopt.toml --mode sbatch --confirm-submit
```
