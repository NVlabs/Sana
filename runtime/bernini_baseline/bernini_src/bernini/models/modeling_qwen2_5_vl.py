...
if fa3_hopper_installed:
    ...
    # Compatibility shim (NOT a perf change): this MLLM runs with
    # mllm_attn_implementation="sdpa" (see config.json / models/bernini.py),
    # and the SDPA vision + decoder classes below do not reference these
    # FlashAttention symbols. Leave them unset on nodes without FA2/FA3 so the
    # module imports and the SDPA path runs; a flash path, if ever selected,
    # would fail at its forward call rather than at import.
