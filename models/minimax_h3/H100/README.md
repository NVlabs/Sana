...
[`minimax_h3_h100_fullopt_exact.toml`](../../../transfeat/minimax_h3/h100_fullopt_exact.toml).
...
```bash
python3 scripts/run.py transfeat/minimax_h3/h100_fullopt_exact.toml                 # the optimized arm
python3 scripts/run.py transfeat/minimax_h3/h100_dense.toml                 # the control it is measured against
```
...
```bash
python3 scripts/run.py transfeat/minimax_h3/h100_fullopt_exact.toml \
...
```bash
python3 scripts/launch_transfeat.py transfeat/minimax_h3/h100_fullopt_exact.toml --mode sbatch --confirm-submit
```
