...
|---:|---|---:|---:|
| 4 | 1344x768 @ 5 s | 81.47 s -> 22.89 s | **3.56x** |
...
```bash
python3 scripts/run.py config/minimax_h3/h100_fullopt_exact.toml                 # the optimized arm
...
```bash
python3 scripts/run.py config/minimax_h3/h100_fullopt_exact.toml \
...
```bash
python3 scripts/launch_config.py config/minimax_h3/h100_fullopt_exact.toml --mode sbatch --confirm-submit
```
