...
The downloader uses pinned Hugging Face revisions. It fetches native H3
transformer/audio weights, the VSA DataFree LoRA, NVFP4 Qwen, H3 upscaler,
...
it does not claim a complete SHA scan. Downloads do not include native BF16
Qwen or H3 video-decoder weights. No inference-time downloads are performed.
...
provided for review; a fresh image build has not been validated.
...
Preparation refuses missing required inputs, mismatched source commits and
