...
#
# Mirrors the existing BlockAdapterRegister idiom: a model registers a ModelSpec
# factory under its transformer class name (or an explicit key), and a new
# technique registers a factory under its name. get_model_spec() resolves a
# live transformer the way BlockAdapterRegister.is_supported() does.
...
from efficiency.technique import Technique
