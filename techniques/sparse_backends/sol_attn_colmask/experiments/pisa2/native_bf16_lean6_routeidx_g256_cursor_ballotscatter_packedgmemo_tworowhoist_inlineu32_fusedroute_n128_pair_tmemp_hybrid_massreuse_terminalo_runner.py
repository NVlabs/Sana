...
def make_native_bf16_lean6_routeidx_g256_cursor_ballotscatter_packedgmemo_tworowhoist_inlineu32_fusedroute_n128_pair_tmemp_hybrid_massreuse_terminalo_runner(
    ...
    *,
    ...
    from kernels.pisa2_sm100.native_bf16_lean6_routeidx_g256_cursor_ballotscatter_packedgmemo_tworowhoist_inlineu32_fusedroute_n128_pair_tmemp_hybrid_massreuse_terminalo_fwd import (
    ...
    op = (
        build_pisa2_sm100_lean6_routeidx_g256_cursor_ballotscatter_packedgmemo_tworowhoist_inlineu32_fusedroute_n128_pair_tmemp_bf16_trace_fwd(T)
        if trace_route_masks
        else build_pisa2_sm100_lean6_routeidx_g256_cursor_ballotscatter_packedgmemo_tworowhoist_inlineu32_fusedroute_n128_pair_tmemp_bf16_fwd(T)
    )
    output_storage = None
    lse_storage = None
    if guard_elements:
