"""Frozen BF16 CuTeDSL-versus-Triton PISA2 full45 contract."""
...
CONTRACT_PATH = ROOT / "workloads" / "pisa2_sm100_bf16_vs_triton_pisa2_full45.json"
...
EXPECTED_CONTRACT = {
    "contract_version": "pisa2-sm100-bf16-vs-triton-pisa2-full45-v1",
    "kernel": {
        "layout": "BHTD",
    ...
    "reference": {
        "R_sem": {"backend": "triton_bf16_pisa2", "group_size": 64},
        "R_perf": {
            "backend": "triton_bf16_pisa2",
        ...
        "secondary": "experiments.pisa2.prepared_reference",
