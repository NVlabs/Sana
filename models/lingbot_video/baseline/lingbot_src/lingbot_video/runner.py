...
# Timing-only instrumentation used by the autovideo adapter. It does not alter
# tensors, control flow, synchronization, or the baseline attention path.
_PHASE_T0 = None
_PHASE_PREV = None
...
def _phase(label: str) -> None:
    ...
    if not _env_flag("LINGBOT_PHASE_TIMING") or not _is_main_process():
        return
