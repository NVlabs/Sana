"""Isolated candidate registry for the source-bound PISA2 full45 harness.
...
BACKENDS = {
    DEFAULT_BACKEND: Full45CandidateBackend(
        ...
        kernel_relative=(
            "kernels/pisa2_sm100/native_bf16_lean6_routeidx_fwd.py"
        ),
        runner_relative=(
            "experiments/pisa2/native_bf16_lean6_routeidx_runner.py"
        ),
        runner_module=(
            "experiments.pisa2.native_bf16_lean6_routeidx_runner"
        ),
        runner_factory="make_native_bf16_lean6_routeidx_runner",
        parent_kernel_relative=(
            "kernels/pisa2_sm100/native_bf16_lean6_maskhoist_fwd.py"
        ),
        parent_runner_relative=(
            "experiments/pisa2/native_bf16_lean6_maskhoist_runner.py"
        ),
        parent_runner_module=(
            "experiments.pisa2.native_bf16_lean6_maskhoist_runner"
        ),
...
def source_paths(
    ...
    *,
    ...
    return {
        ...
        "semantic_helper": (
            root / "experiments/pisa2/check_bf16_cutedsl_semantics.py"
        ),
        "legacy_kernel": (
            root / "kernels/online_piecewise_sparse_attn_bf16_legacy.py"
        ),
        "routing_kernel": root / "kernels/piecewise_sparse_attn_v2.py",
    }
