...
#
# This is the SINGLE source of truth for the scoring/selection logic that was
# previously copy-pasted between the LTX2 stage-1/stage-2 prune and
# cosmos3_token_prune.py. The model-specific bits (which token span is
