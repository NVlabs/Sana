"""Register the RTX 5090 runtime without modifying the SGLang installation."""
...
def register_runtime() -> str:
    ...
    profile = os.environ.get("H3_RTX5090_PROFILE", "dense").strip().lower()
    if profile not in {"dense", "sol", "fullopt"}:
        raise ValueError("H3_RTX5090_PROFILE must be dense, sol, or fullopt")
