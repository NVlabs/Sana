...
- [ ] **fanout search / config manifest / run_orchestrated_experiment.py** —— 未提
...
- [ ] `docs/agent-workflow.md`:workflow_lite (master+executor) · symposium skills · LPIPS+Gemini 质量门 · fanout/config-manifest · per-technique executors
