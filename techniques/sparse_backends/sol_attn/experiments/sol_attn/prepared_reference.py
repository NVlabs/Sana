...
def sol_attn_prepared_route_logits_and_exact_mask(
    q_i8,
    q_scale,
    kc_i8,
    kc_scale,
...
def sol_attn_prepared_reference(
    q_i8,
    k_i8,
    v,
    q_scale,
...
def sol_attn_prepared_reference_query_block(
    q_i8,
    k_i8,
    v,
    q_scale,
    ...
    *,
    ...
    route_logits_all, exact_all = (
        sol_attn_prepared_route_logits_and_exact_mask(
            q_i8,
            q_scale,
            kc_i8,
            kc_scale,
...
def sol_attn_prepared_lse_reference(
    q_i8,
    k_i8,
    q_scale,
    k_scale,
    ...
    This follows the same prepared SOL Attention semantics as
    :func:`sol_attn_prepared_reference`: approximate centroids contribute their
...
def _self_check_case(T=256, seed=0):
    ...
    from kernels.sol_attn_sm90 import SOL_ATTN_GROUP_SIZE, build_sol_attn_sm90_fwd

    torch.manual_seed(seed)
    B, H, D = 1, 1, 128
    block_size = 64
    group_size = SOL_ATTN_GROUP_SIZE
    NT = (T + block_size - 1) // block_size
    ...
    ref_o, ref_lse = sol_attn_prepared_reference(
        q,
        k,
        v,
        q_scale,
...
def main():
    ...
    print("SOL_ATTN_CUTEDSL_PREPARED_REFERENCE_CHECK_DONE")
