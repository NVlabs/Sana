...
- **[2026/08/03]** 🔥 **MiniMax-H3 on-device** [[Model](https://huggingface.co/MiniMaxAI/MiniMax-H3) | [Blog](https://nvlabs.github.io/Sana/Sol-Engine/H3-OnDevice/)] — the same 33B Omni-DiT on on-device GPUs at **3.92×** end-to-end on DGX Spark and **4.52×** on GeForce RTX 5090, from an FP8 checkpoint that fits the model on one card. See [models/minimax_h3/gb10_fp8](models/minimax_h3/gb10_fp8/).
