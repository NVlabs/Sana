...
# refused (the framework analogue of today's BlockAdapterRegister.is_supported).
...
class ModelSpec:
    ...
    # hidden sliced -- e.g. per-token coords/timestep/masks (LTX2) -- provides
    # these so TokenPrune stays generic.
