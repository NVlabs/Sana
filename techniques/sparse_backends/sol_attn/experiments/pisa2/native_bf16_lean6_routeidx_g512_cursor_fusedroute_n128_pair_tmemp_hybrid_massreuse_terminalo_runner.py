...
KERNEL_SHA256 = "d344389a71501eea4da084813a9178967e41c0322dbbbc9553caa0ed07008bc1"
...
def make_native_bf16_lean6_routeidx_g512_cursor_fusedroute_n128_pair_tmemp_hybrid_massreuse_terminalo_runner(
    ...
    *,
    ...
    from kernels.pisa2_sm100.native_bf16_lean6_routeidx_g512_cursor_fusedroute_n128_pair_tmemp_hybrid_massreuse_terminalo_fwd import (
    ...
    op = (
        build_pisa2_sm100_lean6_routeidx_g512_cursor_fusedroute_n128_pair_tmemp_bf16_trace_fwd(T)
        if trace_route_masks
        else build_pisa2_sm100_lean6_routeidx_g512_cursor_fusedroute_n128_pair_tmemp_bf16_fwd(T)
    )
    output_storage = None
    lse_storage = None
    if guard_elements:
