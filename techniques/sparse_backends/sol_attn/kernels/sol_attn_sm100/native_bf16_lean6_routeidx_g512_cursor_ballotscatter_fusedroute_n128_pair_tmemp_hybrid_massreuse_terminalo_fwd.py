...
``7723c2ac``.  It preserves every route/exact phase and mathematical operation,
...
class SolAttentionSm100Lean6RouteidxG512CursorBallot4FusedrouteN128PairTmempBf16Forward:
...
def build_sol_attn_sm100_lean6_routeidx_g512_cursor_ballotscatter_fusedroute_n128_pair_tmemp_bf16_fwd(
    T: int,
    *,
    is_causal: bool = False,
) -> SolAttentionSm100Lean6RouteidxG512CursorBallot4FusedrouteN128PairTmempBf16Forward:
    """Build the ordinary no-trace full-grid sibling."""

    return SolAttentionSm100Lean6RouteidxG512CursorBallot4FusedrouteN128PairTmempBf16Forward(
        T, is_causal=is_causal
    )


def build_sol_attn_sm100_lean6_routeidx_g512_cursor_ballotscatter_fusedroute_n128_pair_tmemp_bf16_trace_fwd(
    T: int,
    *,
    is_causal: bool = False,
) -> SolAttentionSm100Lean6RouteidxG512CursorBallot4FusedrouteN128PairTmempBf16Forward:
