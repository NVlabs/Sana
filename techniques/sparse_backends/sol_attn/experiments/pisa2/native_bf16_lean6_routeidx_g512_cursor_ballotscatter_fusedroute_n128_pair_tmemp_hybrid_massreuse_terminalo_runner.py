...
KERNEL_SHA256 = "75dccb78d282c7741eeb3833ea09af15543438cfe2d207ade9af72d07400feb5"
...
def make_native_bf16_lean6_routeidx_g512_cursor_ballotscatter_fusedroute_n128_pair_tmemp_hybrid_massreuse_terminalo_runner(
    ...
    *,
    ...
    from kernels.pisa2_sm100.native_bf16_lean6_routeidx_g512_cursor_ballotscatter_fusedroute_n128_pair_tmemp_hybrid_massreuse_terminalo_fwd import (
    ...
    op = (
        build_pisa2_sm100_lean6_routeidx_g512_cursor_ballotscatter_fusedroute_n128_pair_tmemp_bf16_trace_fwd(T)
        if trace_route_masks
        else build_pisa2_sm100_lean6_routeidx_g512_cursor_ballotscatter_fusedroute_n128_pair_tmemp_bf16_fwd(T)
    )
    output_storage = None
    lse_storage = None
    if guard_elements:
