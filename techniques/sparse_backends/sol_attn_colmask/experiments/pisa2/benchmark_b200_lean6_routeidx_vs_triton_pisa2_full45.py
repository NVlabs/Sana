...
CONTRACT = "b200_lean6_routeidx_vs_triton_pisa2_full45_v1"
BACKENDS = ("lean6_routeidx", "triton_pisa2_R_perf")
...
CORRECTNESS_SOURCE = (
    ROOT / "experiments/pisa2/check_b200_lean6_routeidx_full45_correctness.py"
)
...
def _run_case(
    ...
    *,
    ...
    performance_runner, tuning = _autotune_triton_pisa2(
