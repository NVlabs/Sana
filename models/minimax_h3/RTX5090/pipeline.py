"""RTX 5090 pipeline stages that differ from pinned SGLang MiniMax-H3."""
...
class RTX5090MiniMaxH3DenoisingStage(MiniMaxH3DenoisingStage):
...
class RTX5090MiniMaxH3DecodingStage(MiniMaxH3DecodingStage):
...
class MiniMaxH3RTX5090Pipeline(MiniMaxH3Pipeline):
    """Stock MiniMax-H3 wiring with two RTX-5090 memory-stage overrides."""
    ...
    def create_pipeline_stages(self, server_args: ServerArgs) -> None:
        ...
        self.add_stage(
            RTX5090MiniMaxH3DenoisingStage(
                transformer=self.get_module("transformer"),
                pipeline=self,
            )
        )
        self.add_stage(
            RTX5090MiniMaxH3DecodingStage(
                video_vae=self.get_module("video_vae"),
                audio_vae=self.get_module("audio_vae"),
            )
        )
...
EntryClass = MiniMaxH3RTX5090Pipeline


__all__ = [
    "MiniMaxH3RTX5090Pipeline",
    "RTX5090MiniMaxH3DecodingStage",
    "RTX5090MiniMaxH3DenoisingStage",
]
