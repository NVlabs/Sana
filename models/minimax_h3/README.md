...
- `h100/`: the self-contained four-H100 BF16 SGLang runtime using the SM90
  CuTe Sol-Attn backend.
- `a100/`: the self-contained four-A100 BF16 SGLang runtime using the Triton
  Sol-Attn backend.
