...
TIMING_HARNESS_SOURCE = (
    ROOT / "experiments/pisa2/benchmark_b200_lean6_routeidx_vs_triton_pisa2_full45.py"
)
...
KERNEL_RELATIVE = "kernels/pisa2_sm100/native_bf16_lean6_routeidx_fwd.py"
RUNTIME_FIELDS = {
...
def _device_run(args: argparse.Namespace) -> None:
    ...
    from experiments.pisa2 import check_bf16_cutedsl_semantics as semantic
    from experiments.pisa2.prepared_reference import pisa2_prepared_reference_query_block
            ...
            for batch, heads in BATCH_HEAD_PAIRS:
                for density in DENSITIES:
                    row = _run_gpu_case(
                        ...
                        pisa2_prepared_reference_query_block,
                        make_candidate,
                        make_parent,
