...
from techniques.nvfp4_profile import (
    format_int_ranges,
...
class NVFP4FFN(ModelTransform):
    ...
    epilogues, padding policy, and config metadata. A target loader may
    ignore metadata env until a config explicitly wires and validates it.
    """
