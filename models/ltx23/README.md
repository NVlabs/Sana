...
candidates/ltx23_{baseline,fullopt}.toml
...
`scripts/launch_candidate.py` generates `launch.sh`, which cd's to the runtime
...
`candidates/ltx23_baseline.toml`.
...
2026-06-20 by `5b725f0` ("Add model-agnostic efficiency candidates and audits"),
