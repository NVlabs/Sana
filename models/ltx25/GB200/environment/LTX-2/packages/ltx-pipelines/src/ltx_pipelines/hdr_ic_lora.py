...
"""
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Optional path to a separate diffusion-VAE checkpoint (.safetensors). "
            "When set, video decoding uses this checkpoint instead of "
            "--distilled-checkpoint-path, building a DiffusionVideoDecoder instead of "
            "the usual convolutional one. Requires the natten extra "
