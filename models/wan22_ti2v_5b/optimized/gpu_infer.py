...
def main():
    ...
    if kernel_runtime.active:
        log(
            ...
            f"stack={list(kernel_runtime.stack)} active_config={kernel_runtime.active_config or None} "
    ...
    if paired_dit is not None:
        log(
            f"paired DiT {paired_dit['config']} OFF={paired_dit['off']['median_ms']:.3f}ms "
    ...
    if profile_result is not None:
        ...
        bench["profile_timing_warning"] = "Profiled timing includes Kineto overhead and is not a speed config."
