...
| H100 | 4 | 768p@5s | 81.47 | 22.89 | **3.56x** | [`h100_fullopt.toml`](../../config/minimax_h3/h100_fullopt.toml) |
| A100 | 4 | 768p@5s | 217.32 | 61.28 | **3.55x** | [`a100_fullopt.toml`](../../config/minimax_h3/a100_fullopt.toml) |
...
python scripts/launch_config.py \
  config/minimax_h3/h100_fullopt.toml \
  --mode sbatch --confirm-submit \
