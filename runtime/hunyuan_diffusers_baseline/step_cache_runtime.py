...
def maybe_enable(pipe) -> dict | None:
    ...
    from efficiency.registry import build_technique
    from efficiency.technique import TechniqueContext
    from efficiency.techniques.teacache import teacache_relative_l1
