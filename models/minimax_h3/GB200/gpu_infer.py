...
clean A/B. The config manifests in `config/minimax_h3_*.toml` pin the combinations that
were measured.
"""
...
for _vendored in (os.path.join(_HERE, "vendor_site"),
                  os.path.join(_HERE, "diffusers_src", "src")):
