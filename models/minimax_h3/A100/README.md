...
by [`minimax_h3_a100_fullopt_exact.toml`](../../../config/minimax_h3/a100_fullopt_exact.toml).
...
```bash
python3 scripts/run.py config/minimax_h3/a100_fullopt_exact.toml                 # the optimized arm
...
```bash
python3 scripts/run.py config/minimax_h3/a100_fullopt_exact.toml \
...
```bash
python3 scripts/launch_config.py config/minimax_h3/a100_fullopt_exact.toml --mode sbatch --confirm-submit
```
