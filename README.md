...
- 🔥 [2026/09] ⚡ **SANA-Video 2.0 5B 4-Step Preview** is released! The T2V-only DMD preview generates 720p videos in four denoising steps, supports 5-second and 8-second outputs, and exposes Motion Score and RL LoRA scale controls online. See [Online Demo](https://huggingface.co/spaces/Efficient-Large-Model/sana-video2-5b-720p-demo) | [4-Step Weights](https://huggingface.co/Efficient-Large-Model/SANA-Video_2.0_5B_720p_4step) | [Doc](https://nvlabs.github.io/Sana/docs/sana_video2/) | [Project](https://nvlabs.github.io/Sana/Video2/).
