...
- **2026-07-21** — Merged [**SOL Attention**](techniques/sparse_backends/)
  ...
  - [**Wan2.1-T2V-14B**](models/wan21_t2v_14b/): **3.08×** warm generation
    speedup (564.0 s → 182.9 s; 3.5–3.7× on showcase prompts) with
...
| [**Wan2.1-T2V-14B**](models/wan21_t2v_14b/) | **3.08×** (564.0 s → 182.9 s, warm) | compile + EasyCache + [**SOL Attention**](techniques/sparse_backends/sol_attn_backend.py) (colmask d=0.15, Morton, dense guard) | `runs/20260717-142314-wan21_14b_fullstack` |
