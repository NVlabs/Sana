...
class VideoLatentPatchifier(Patchifier):
    ...
    def get_patch_grid_bounds(
        ...
        Args:
            ...
            temporal_offset: Offset added to temporal coordinates so that
                windowed processing produces globally-continuous RoPE positions.
        """
        ...
        grid_coords = torch.meshgrid(
            torch.arange(start=temporal_offset, end=temporal_offset + frames, step=self._patch_size[0], device=device),
